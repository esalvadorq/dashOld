<div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show" id="sidebar">
    <div class="c-sidebar-brand d-lg-down-none">
        <svg class="c-sidebar-brand-full" width="118" height="46" alt="DashOld Logo">
            <use xlink:href="{{ asset('img/brand/icon.svg#type') }}"></use>
        </svg>
        <svg class="c-sidebar-brand-minimized" width="46" height="46" alt="DashOld Logo">
            <use xlink:href="{{ asset('img/brand/icon.svg#icon') }}"></use>
        </svg>
        {{-- <img src="{{ asset('img/brand/icon.png') }}" style="width:50px;margin-right:8px;" alt=""> --}}
    ...
    <ul class="c-sidebar-nav">
        ...
        <li class="c-sidebar-nav-dropdown">
            <x-utils.link href="#" icon="c-sidebar-nav-icon cil-layers" class="c-sidebar-nav-dropdown-toggle"
                :text="__('Product')" />
            <ul class="c-sidebar-nav-dropdown-items">
                <li class="c-sidebar-nav-item">
